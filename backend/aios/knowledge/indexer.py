...
async def index_file(file_path: Path, force: bool = False) -> str | None:
    ...
    try:
        ...
        logger.exception("Failed to index file", path=str(file_path), error=str(e))
        return None
...
async def search_index(
    ...
    try:
        ...
        logger.exception("Index search failed", query=query, error=str(e))
        return []
